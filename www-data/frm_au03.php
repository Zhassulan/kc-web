<form id="frm" name="frm" method="post" action="cabinet.php?p=AU03" enctype="multipart/form-data">
...
<div class="table-responsive">
		<table class="table table-bordered" id="myTable" name="myTable">
		    ...
		    if (isset($_POST['PostAU03'])) SendAU03();
		    
		    if (!isset($_SESSION['AU03_rows'])) $_SESSION['AU03_rows'] = 1;
		    if (isset($_POST['AddRow']))
		    	{
		    	if (isset($_SESSION['AU03_rows']))
		    		{
		    		$_SESSION['AU03_rows'] = intval($_SESSION['AU03_rows']) + 1;
		    		unset($_SESSION['id']);
		    		}	
		    	}
		    ...
		    for ($i=1; $i <= intval($_SESSION['AU03_rows']); $i++)
		    	...
		    	echo '<tr>
						...
						<td>
							<input type="text" class="form-control" id="edtLotNumber'.$i.'" name="edtLotNumber'.$i.'" value="'.$lot.'">
						</td>
						<td>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-success" onclick="SignAndVerify('AU03');">Подписать</button>
	      </div>
	    </div>
	  </div>
	</div>
...
<button type="submit" class="btn btn-success" id="PostAU03" name="PostAU03">Отправить</button>
&nbsp&nbsp
