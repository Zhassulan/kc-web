...
if (isset($_POST["SendAU01"])) SendAU01();
?>
<form id="frm" name="frm" method="post" action="cabinet.php?p=AU01" enctype="multipart/form-data">
		    ...
		    <tbody>
		     <tr>
				...
				<div class="col-md-9">
					...
					<?php
						if (isset($_SESSION['client_id']))
							{
							echo html_quot(db_get_customer_by_id($_SESSION['client_id'], 'full_name'));
							echo '<input type="hidden" id="edtClient" name="edtClient" value="'.html_quot(db_get_customer_by_id($_SESSION['client_id'], 'full_name')).'">';
							}
						else
				...
				<td class="col-md-3">
					...
					if (isset($_SESSION['client_id']))
						{
						echo '<input type="hidden" id="edtClientBin" name="edtClientBin" value="'.db_get_customer_by_id($_SESSION['client_id'], 'BIN').'">';
						echo db_get_customer_by_id($_SESSION['client_id'], 'BIN');
						}
					?>
				</td>
			 </tr>
...
<div class="table-responsive">
		<table class="table table-bordered" id="myTable" name="myTable">
		    ...
		    <tbody>
		    <?php
		    if (!isset($_SESSION['AU01_rows']))	$_SESSION['AU01_rows'] = 1;
		    if (isset($_POST['AddRow']))
		    	if (isset($_SESSION['AU01_rows']))
	    			$_SESSION['AU01_rows'] = intval($_SESSION['AU01_rows']) + 1;
		    if (isset($_POST['DelRow']))
		    		if (isset($_SESSION['AU01_rows']))
		    			if (intval($_SESSION['AU01_rows']) > 1)
		    				$_SESSION['AU01_rows'] = intval($_SESSION['AU01_rows']) - 1;
...
<div class="row">
 <p class="text-right">
	<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Подписать</button>
</p>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-success" onclick="SignAndVerify('AU01');">Подписать</button>
	      </div>
	    </div>
	  </div>
	</div>
...
<button type="submit" class="btn btn-success" id="SendAU01" name="SendAU01">Отправить</button>
&nbsp&nbsp
