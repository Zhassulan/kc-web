...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Client">
    ...
    <tr>
      ...
      <td class="hdr01" >Состояние Сделки</td>
      <td class="hdr01" >Дата исп-ния Сделки</td>
      <td class="hdr01" >Дата и время факт. исполнения Сделки</td>
      ...
      <td colSpan="1" class="dat01_l">
        <xsl:choose>
          <xsl:when test="@State[.='WAITING']">
            <xsl:text>не исполнена</xsl:text>
          </xsl:when>
