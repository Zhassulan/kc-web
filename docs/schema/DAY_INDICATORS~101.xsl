...
<xsl:element name="table">
    ...
    <col width="100" />
      ...
      <tr height="40">
        <td class="tit" colspan="4">Информация о ценах на рынке ЕТС</td>
      </tr>
      <tr height="20">
        <td class="tit_2" colspan="4"><xsl:value-of select="@DateFrom" /></td>
      </tr>
    ...
    <tr>
        <td class="hdr01" rowspan="1" colspan="1">Источник</td>
        <td class="hdr01" rowspan="1" colspan="1">Цена за одну тонну</td>
        <td class="hdr01" rowspan="1" colspan="1">Изменения за 1 день,%</td>
        <td class="hdr01" rowspan="1" colspan="1">Изменения за 1 день,тенге</td>
    </tr>
...
<xsl:template match="List">
      ...
      <tr height="20">
        ...
        <td class="hdr04" colspan="4"><xsl:value-of select="@Name" /></td>
      </tr>

    <xsl:apply-templates select="DayIdx"/>

</xsl:template>


 <xsl:template match="DayIdx">

    <tr>
        <td class="dat02"><xsl:value-of select="@Source" /></td>
        <td class="dat01"><xsl:value-of select="@AvrPrice" /></td>
        <td class="dat01"><xsl:value-of select="@DeltaPer" /></td>
        <td class="dat01"><xsl:value-of select="@Delta" /></td>
     </tr>
