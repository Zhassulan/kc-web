  ...
  <xsl:template match="Receiver">
    <xsl:element name="table">
      ...
      <tr>
        ...
        <td class="hdr01">Бин клиента</td>
        <td class="hdr01">Наименование</td>
        <td class="hdr01">Дата регистрации</td>
        <td class="hdr01">Дата удаления</td>
        <td class="hdr01">Активность</td>
        <td class="hdr01">Примечание</td>
      </tr>
