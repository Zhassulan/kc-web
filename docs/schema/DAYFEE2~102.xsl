...
<tr>
<td class="sign5" rowspan="2"><img src="https://kc-ets.kz/docs/schema/qr.png" width="200" height="200" alt="submit"></img></td>
</tr>
  ...
  <xsl:template match="FeeScheme">
    ...
    <tr>
      ...
      <td colSpan="3" class="hdr01">Описание комиссии</td>
    </tr>
    <tr>
      ...
      <td colSpan="3" class="dat01L">
        <xsl:value-of select="@Descr" />
      </td>
    </tr>

    <tr>
      <td colSpan="1" class="hdr01">Номер сделки</td>
      <td colSpan="1" class="hdr01">Направление сделки</td>
      <td colSpan="1" class="hdr01">Код Клиента</td>
      <td colSpan="1" class="hdr01">Листинг товаров</td>
      <td class="hdr01">Сумма комиссии, каз. тенге</td>
      <td class="hdr01">в т.ч. НДС</td>
    </tr>

    <xsl:apply-templates select="Fee"/>
    <xsl:apply-templates select="FeeSchemeSum"/>
  ...
  <xsl:template match="Total">
    ...
    <tr height="8" >
     ...
     <tr>
        <td class="np" colspan="3"></td>
        <td class="hdr01" colspan="1">ИТОГО</td>
  ...
  <xsl:template match="Fee">
    ...
    <xsl:template match="FeeSchemeSum">

     <tr>
        <td class="np" colspan="3"></td>
        <td class="hdr01" colspan="1">Итого по разделу</td>
        <xsl:apply-templates select="FeeSum[@Currency='KZT']" />
      </tr>
      <!--tr>
         <td class="np" colspan="5"></td>
