...
<xsl:element name="table">
    ...
    <col width="200" />
      ...
      <tr>
        <td class="sign4" rowspan="2"><img src="ftp://ftp.ets.kz/Plaza/Schema/ets001.jpg" width="105" height="25" alt="submit"></img></td>
        <td class="sign2" colspan="6">Данный документ передан в электронном виде и подписан электронной цифровой подписью</td>
        <td class="sign5" rowspan="2"><img src="ftp://ftp.ets.kz/Plaza/Schema/ets001.jpg" width="105" height="25" alt="submit"></img></td>
      </tr>

      <tr>
         <td class="sign2" colspan="6">Акционерного общества "Товарная биржа "Евразийская Торговая Система"</td>
      </tr>
      ...
      <tr height="20">
        <td class="tit" colspan="8">Отчет о выставленных заявках по Аукциону</td>
      </tr>
    ...
    <tr>
        ...
        <td class="hdr01" rowspan="1" colspan="1">Время регистрации заявки</td>
        <td class="hdr01" rowspan="1" colspan="1">Идентиф. номер заявки</td>
        <!--td class="hdr01" rowspan="1" colspan="1">Код заказчика</td-->
        <!--td class="hdr01" rowspan="1" colspan="1">Название заказчика</td-->
        <!--td class="hdr01" rowspan="1" colspan="1">Наименование брокера/дилера</td-->
        <td class="hdr01" rowspan="1" colspan="1">Наименование брокера участника</td>
        <td class="hdr01" rowspan="1" colspan="1">Наименование заявителя, по поручению которого объявлена заявка</td>
        <td class="hdr01" rowspan="1" colspan="1">РНН заявителя</td>
        <td class="hdr01" rowspan="1" colspan="1">Цена за лот (<xsl:value-of select="/Receiver/Report/@PriceCurrency"/>) </td>
        <!--class="hdr01" rowspan="1" colspan="1">Кол-во</td -->
        <!--td class="hdr01" rowspan="1" colspan="1">Сумма</td-->
        <td class="hdr01" rowspan="1" colspan="1">Memo уч-ка</td>
    </tr>
...
<xsl:template match="Report">
    ...
    <tr>
        <td class="hdr01" colspan="2">Дата проведения</td>
